...
const services = [
  {
    ...
    link: "https://t.me/The_magic_of_stones_bot?start=diagnostika",
    featured: true,
  },
  {
    icon: Sparkles,
  ...
  },
  {
    ...
    cta: "Записаться",
    link: "https://t.me/The_magic_of_stones_bot?start=snyatie",
    featured: false,
  },
  {
    icon: Heart,
    ...
    link: "https://t.me/The_magic_of_stones_bot?start=soprovozhdenie",
    featured: false,
  },
  {
    icon: BookOpen,
    ...
    price: "от 1 500 ₽",
    description: "Разовая консультация для тех, кто хочет разобраться в своей коллекции минералов, узнать о совместимости камней или получить ответы на конкретные вопросы по работе с минералами. Консультация проводится в формате голосового или видеозвонка и длится до одного часа.",
    includes: [
    ...
    link: "https://t.me/The_magic_of_stones_bot?start=konsultaciya",
    featured: false,
  },
  {
    icon: Users,
    title: "Групповая медитация с камнями",
    price: "от 500 ₽",
    description: "Онлайн-медитации в небольших группах с использованием минералов. Каждая медитация посвящена определённой теме: заземление, раскрытие сердца, активация интуиции, привлечение изобилия. Участники получают инструкции по подбору камней для медитации и подробные гайды по практике.",
    includes: [
